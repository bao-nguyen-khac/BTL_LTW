...
INSERT INTO `quantrivien` (`id`, `taikhoan`, `matkhau`, `ten`) VALUES
...
INSERT INTO `nguoidung` (`id`, `taikhoan`, `matkhau`, `diachi`, `ten`, `sodienthoai`) VALUES
(1, 'user1', '24c9e15e52afc47c225b757e7bee1f9d', 'Việt Nam', 'User', '0941123456');
...
INSERT INTO `sanpham_donhang` (`donhang_id`, `sanpham_id`, `tensanpham`, `soluong`) VALUES
...
CREATE TABLE `chitiet_donhang` (
  `donhang_id` int(255) NOT NULL,
  `nguoidung_id` varchar(255) NOT NULL,
...
INSERT INTO `chitiet_donhang` (`donhang_id`, `nguoidung_id`, `ngay_dat`, `gia`, `trangthai`, `an`) VALUES
...
CREATE TABLE `sanpham` (
  ...
  `mota_phu` text NOT NULL,
  `mota_chinh` text NOT NULL,
  `sanpham_noibat` tinyint(1) NOT NULL,
...
INSERT INTO `sanpham` (`id`, `ten`, `gia`, `anh`, `theloai_id`, `mota_phu`, `mota_chinh`, `sanpham_noibat`, `sanpham_moi`) VALUES
...
--
ALTER TABLE `chitiet_donhang`
  MODIFY `donhang_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
